...
const socials = [
  {
    icon: Facebook,
    href: "https://www.facebook.com/bluechillidp/",
    label: "Facebook",
  },
  {
    icon: Twitter,
    href: "https://x.com/wearebluechilli?s=11&t=_AcW3bHABp5pRl4q4ngI0Q",
    label: "X",
  },
  {
    icon: Linkedin,
    href: "https://www.linkedin.com/company/bluechilli-design-print/",
    label: "LinkedIn",
  },
  {
    icon: Instagram,
    href: "https://www.instagram.com/wearebluechilli/",
    label: "Instagram",
  },
  {
    icon: Youtube,
    href: "https://www.youtube.com/@BluechilliAI",
    label: "YouTube",
  },
];
...
const Footer = () => {
  ...
  return (
    <footer ref={footerRef} className="relative overflow-hidden bg-[#030308]">
            ...
            <div className="relative px-8 py-14 md:px-16 md:py-20 flex flex-col md:flex-row items-center justify-between gap-10">
              ...
              <div className="text-center md:text-left max-w-lg">
                ...
                <p className="text-white/50 text-sm leading-relaxed">
                  Join businesses like yours using Bluechilli AI — set up in one
                  day, results from day one.
                </p>
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-2 mt-6">
                  {stats.map((s) => (
                    <div
                      key={s.label}
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/[0.06] border border-white/[0.09]"
                    >
      ...
      <div
        ref={contentRef}
        className="relative container mx-auto px-6 pb-10 max-w-7xl"
      >
        {/* divider */}
        ...
        <div className="footer-col grid grid-cols-1 md:grid-cols-[1.6fr_1fr_1fr_1fr] gap-12 mb-14">
          ...
          <div className="space-y-5">
            ...
            {/* newsletter */}
            <div className="pt-2">
              <p className="text-sm font-bold uppercase tracking-widest text-white/45 mb-3">
                Newsletter
              </p>
              <form
          ...
          {navCols.map((col) => (
            <div key={col.title}>
              <p className="text-sm font-bold uppercase tracking-widest text-white/45 mb-5">
                {col.title}
              </p>
