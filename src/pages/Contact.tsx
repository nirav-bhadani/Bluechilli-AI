      ...
      <main className="relative pt-28 md:pt-32 pb-24">
        ...
        <section className="container mx-auto px-4 sm:px-6 relative max-w-full lg:max-w-7xl">
          ...
          <AnimatedSection className="text-center mb-16 md:mb-20">
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.15] mb-6">
              Let's <span className="gradient-text">Connect</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Ready to transform your customer communication? Our team is here to help you every step of the way.
            </p>
          </AnimatedSection>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-[400px_1px_minmax(0,1fr)] lg:gap-12 gap-8">
                ...
                <div className="space-y-5 lg:space-y-6">
                  <div>
                    <h3 className="font-display text-2xl md:text-3xl font-bold text-white/95 mb-2">Get in Touch</h3>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-white/75 mb-2">WhatsApp</p>
                        <a href="https://wa.me/15557423957" target="_blank" rel="noreferrer" className="font-display text-lg font-bold text-white/90 hover:text-green-400 transition-colors">
                          Chat with Blu
                        </a>
                        <p className="text-xs text-green-400/70 mt-1">Available 24/7</p>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-white/75 mb-2">Email</p>
                        <a href="mailto:hello@bluechilli.ai" className="font-display text-lg font-bold text-white/90 hover:text-purple-400 transition-colors break-all">
                          hello@bluechilli.ai
                        </a>
                      </div>
                    </div>
          ...
          <AnimatedSection className="">
            <div className="text-center mb-12">
              <h2 className="font-display text-3xl md:text-4xl font-bold text-white/95 mb-3">Email Us Directly</h2>
              <p className="text-lg text-white/60">Reach the right team for your enquiry</p>
            </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ background: `linear-gradient(90deg, ${dept.color}, transparent 75%)` }}
                      />
